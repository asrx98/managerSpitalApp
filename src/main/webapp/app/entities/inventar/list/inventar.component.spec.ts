...
describe('Component Tests', () => {
  describe('Inventar Management Component', () => {
    let comp: InventarComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InventarComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inventars?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
