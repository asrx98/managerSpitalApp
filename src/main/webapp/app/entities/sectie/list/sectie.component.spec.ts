...
describe('Component Tests', () => {
  describe('Sectie Management Component', () => {
    let comp: SectieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SectieComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.secties?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
