...
describe('Component Tests', () => {
  describe('Pacient Management Component', () => {
    let comp: PacientComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PacientComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pacients?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
